...
from models.graspnet import GraspNet, get_loss, MyGraspNet
...
parser.add_argument('--log_dir', default='new_logs/log_my_kn', help='Dump dir to save model checkpoint [default: log]')
